...
/**
 * Populates the embedded MongoDB with realistic dummy data (only used in dev)
 */
@Profile("dev")
@Configuration
public class MockDataInitializer implements CommandLineRunner {
    ...
    public MockDataInitializer(CampusRepository cRepo, BuildingRepository bRepo, RoomRepository rRepo) {
    ...
    public void run(String... args) throws Exception {
        ...
        Address bsnAddress = new Address("4202 E. Fowler Ave.", "BSN 3403", "Tampa", "FL", "33620", Address.Country.USA);
        Address necAddress = new Address("4202 E. Fowler Ave.", "SVC1072", "Tampa", "FL", "33620", Address.Country.USA);
        ...
        Address usfAddress = new Address("4202 E. Fowler Ave.", "Tampa", "FL", "33620", Address.Country.USA);
