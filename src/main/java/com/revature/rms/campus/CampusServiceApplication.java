...
//	@Bean
//	public CommandLineRunner demo(CampusRepository repository){
//
//		return (args) -> {
...
//			corporate.add(2);
//			corporate.add(3);
//			repository.save(new Campus("1","University of South Florida", "USF", address, 1, 2, 3, campus1Buildings, corporate, meta));
//		};
//	}
