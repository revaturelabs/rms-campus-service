...
public class CampusServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		work17.add("17");
		Room room1 = new Room("1","107", 24, true,  roomStatus1, "1", work1, meta);
		Room room2 = new Room("2","300", 30, true,  roomStatus2, "2", work2, meta);
		Room room3 = new Room("3","320", 28, true,  roomStatus3, "3", work3, meta);
		Room room4 = new Room("4","328", 45, true,  roomStatus4, "4", work4, meta);
		Room room5 = new Room("5","200A", 26, true,  roomStatus5, "5", work5, meta);
		Room room6 = new Room("6","200B", 26, true, roomStatus6, "6", work6, meta);
		Room room7 = new Room("7","1300", 30, true,  roomStatus7, "7", work7, meta);
		Room room8 = new Room("8","1304", 26, true,  roomStatus8, "8", work8, meta);
		Room room9 = new Room("9","1400", 26, true,  roomStatus9, "9", work9, meta);
		Room room10 = new Room("10","1402", 30, true,  roomStatus10, "10", work10, meta);
		Room room11 = new Room("11","2301A", 15, true,  roomStatus11, "11", work11, meta);
		Room room12 = new Room("12","2301B", 15, true,  roomStatus12, "12", work12, meta);
		Room room13 = new Room("13","2301C", 15, true, roomStatus13, "13", work13, meta);
		Room room14 = new Room("14","2301D", 15, true, roomStatus14, "14", work14, meta);
		Room room15 = new Room("15","2300", 30, true, roomStatus15, "15", work15, meta);
		Room room16 = new Room("16","2303", 30, true, roomStatus16, "16", work16, meta);
		Room room17 = new Room("17","2304", 30, true, roomStatus17, "17", work17, meta);
		...
		Building building1 = new Building("1","NEC", "NEC", address, 5, amenities, building1Rooms, meta);
		Building building2 = new Building("2","MUMA School of Business", "BSN", address, 4, amenities, building2Rooms, meta);
